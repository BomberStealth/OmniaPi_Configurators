...
export const DEVICES: Device[] = [
  { id: 'hub', codice: '51174.134.WH1', img: hub, nome: 'Hub 2 (4G)', tag: 'Il cervello dell’impianto',
    desc: 'È il cuore del sistema: riceve i segnali da tutti i sensori e, se qualcosa non va, avvisa te sul telefono e l’eventuale vigilanza. Si collega a internet via cavo e scheda SIM 4G, così resta sempre attivo anche se salta la linea o la corrente.',
    specs: ['Ethernet + 4G', 'Notifiche in tempo reale', 'Autonomia fino a 7 anni'], listino: 645 },
  { id: 'hub_plus', codice: '156255.382.WH1', img: hub, nome: 'Hub 2 Plus', tag: 'Centrale con foto-verifica',
  ...
  { id: 'button', codice: '38095.26.WH1', img: button, nome: 'Button', tag: 'Aiuto immediato',
    ...
    specs: ['Allarme antipanico', 'Programmabile', 'Wireless'], listino: 49 },
  ...
  { id: 'motioncam_out', codice: '39293.121.WH1', img: motioncamOut, nome: 'MotionCam Outdoor', tag: 'Movimento esterno con foto-verifica',
    ...
    specs: ['Da esterno', 'Foto-verifica', 'Pet-immune', 'Anti-mascheramento'], listino: 416 },
  { id: 'curtaincam_out', codice: '99164.282.WH1', img: curtaincamOut, nome: 'MotionCam Outdoor HM', tag: 'Montaggio a 2,4MT con foto-verifica',
    desc: 'Rilevatore di movimento da esterno che, quando scatta l’allarme, scatta anche una serie di foto: così vedi subito sul telefono cosa ha fatto scattare l’allarme, ancora prima che qualcuno entri. Si monta a un’altezza di 2,4MT. Ignora cani e gatti e resiste al maltempo.',
    specs: ['Da esterno', 'Foto-verifica', 'Pet-immune', 'Anti-mascheramento'], listino: 496 },
