...
// Codici interni AS400 da preventivo EDIF (Rimini Inst, 28/05/26)
// ─────────────────────────────────────────────────────────────────────────────
export const DEFAULT_CATALOG: WCatalog = {
  inverters: [

    // ── Monofase Di Stringa — W-HPK (1 MPPT) — pag. 7 ───────────────────────
    inv('w-hpk-1k',     'mono','ongrid','W-HPK',  1.0, 1,'W-HPK-1K',    '017761','INVERTER STRINGA MONO 1kW 1MPPT W-HPK-1K',    '463276'),
    inv('w-hpk-1.5k',   'mono','ongrid','W-HPK',  1.5, 1,'W-HPK-1.5K',  '017762','INVERTER STRINGA MONO 1.5kW 1MPPT W-HPK-1.5K','448247'),
    inv('w-hpk-2k',     'mono','ongrid','W-HPK',  2.0, 1,'W-HPK-2K',    '017763','INVERTER STRINGA MONO 2kW 1MPPT W-HPK-2K',    '456493'),
    inv('w-hpk-2.5k',   'mono','ongrid','W-HPK',  2.5, 1,'W-HPK-2.5K',  '017727','INVERTER STRINGA MONO 2.5kW 1MPPT W-HPK-2.5K','492930'),
    inv('w-hpk-3k',     'mono','ongrid','W-HPK',  3.0, 1,'W-HPK-3K',    '017637','INVERTER STRINGA MONO 3kW 1MPPT W-HPK-3K',    '448067'),
    ...
    inv('w-hes-3k',     'mono','hybrid','W-HES',  3.0, 2,'W-HES-3K',    '019090','INVERTER IBRIDO MONO BT 3kW 2MPPT W-HES-3K',     '560257','low', 60),
    inv('w-hes-3.68k',  'mono','hybrid','W-HES',  3.68,2,'W-HES-3.68K', '019091','INVERTER IBRIDO MONO BT 3.68kW 2MPPT W-HES-3.68K','',     'low', 60),
    inv('w-hes-4k',     'mono','hybrid','W-HES',  4.0, 2,'W-HES-4K',    '019092','INVERTER IBRIDO MONO BT 4kW 2MPPT W-HES-4K',     '561279','low', 60),
    inv('w-hes-5k',     'mono','hybrid','W-HES',  5.0, 2,'W-HES-5K',    '019093','INVERTER IBRIDO MONO BT 5kW 2MPPT W-HES-5K',     '561281','low', 60),
    ...
    inv('w-hpt-6kp',    'tri','ongrid','W-HPT',   6.0, 2,'W-HPT-6KP',   '019745','INVERTER STRINGA TRI 6kW 2MPPT W-HPT-6KP',   '609525'),
    inv('w-hpt-8kp',    'tri','ongrid','W-HPT',   8.0, 2,'W-HPT-8KP',   '019797','INVERTER STRINGA TRI 8kW 2MPPT W-HPT-8KP',    ''),
    inv('w-hpt-10kp',   'tri','ongrid','W-HPT',  10.0, 2,'W-HPT-10KP',  '019746','INVERTER STRINGA TRI 10kW 2MPPT W-HPT-10KP', '604067'),
    inv('w-hpt-15kp',   'tri','ongrid','W-HPT',  15.0, 2,'W-HPT-15KP',  '019747','INVERTER STRINGA TRI 15kW 2MPPT W-HPT-15KP', '606342'),

    // ── Trifase Di Stringa — W-HPT (2 MPPT, 20-25kW) — pag. 15 ────────────
    inv('w-hpt-20k',    'tri','ongrid','W-HPT',  20.0, 2,'W-HPT-20K',   '017736','INVERTER STRINGA TRI 20kW 2MPPT W-HPT-20K',  '470008'),
    ...
    inv('w-hpt-33k',    'tri','ongrid','W-HPT',  33.0, 3,'W-HPT-33K',   '018252','INVERTER STRINGA TRI 33kW 3MPPT W-HPT-33K',  '468808'),
    ...
    inv('w-hpt-50k',    'tri','ongrid','W-HPT',  50.0, 4,'W-HPT-50K',   '018255','INVERTER STRINGA TRI 50kW 4MPPT W-HPT-50K',  '468807'),

    // ── Trifase Di Stringa — W-HPT (6 MPPT, 80kW) — pag. 19 ────────────────
    inv('w-hpt-80k',    'tri','ongrid','W-HPT',  80.0, 6,'W-HPT-80K',   '019357','INVERTER STRINGA TRI 80kW 6MPPT W-HPT-80K',  '578936'),
    ...
    inv('w-hht-8k',     'tri','hybrid','W-HHT',   8.0, 2,'W-HHT-8K',    '018640','INVERTER IBRIDO TRI AT 8kW 2MPPT W-HHT-8K',   '509366','high',800),
    inv('w-hht-10k',    'tri','hybrid','W-HHT',  10.0, 2,'W-HHT-10K',   '018641','INVERTER IBRIDO TRI AT 10kW 2MPPT W-HHT-10K', '508265','high',800),
  ],
